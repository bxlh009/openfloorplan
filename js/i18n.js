...
(function () {
  const dict = {
    zh: {
      ...
      'level.add': '新增空白楼层', 'level.copy': '复制当前楼层', 'level.summary': '标高 {elevation} cm · 层高 {height} cm · 楼板 {thickness} cm',
      ...
      'status.autosave': '本地自动保存', 'status.newProject': '已新建空白项目并更新本地草稿', 'status.loadedProject': '已载入项目并更新本地草稿', 'status.backupExported': 'JSON 备份已导出；清除浏览器数据前请保留此文件',
      ...
      'status.selected': '已选择', 'message.dimensionStart': '单击设置标注起点', 'message.dimensionEnd': '单击设置标注终点',
      ...
      'prop.steps': '级数',
      'object.wall': '墙体', 'object.door': '门', 'object.window': '窗', 'object.furniture': '家具', 'action.delete': '删除',
    ...
    en: {
      ...
      'level.add': 'Add blank level', 'level.copy': 'Duplicate current level', 'level.summary': 'Elevation {elevation} cm · Height {height} cm · Slab {thickness} cm',
      ...
      'status.autosave': 'Saved locally', 'status.newProject': 'Created a blank project and updated the local draft', 'status.loadedProject': 'Loaded the project and updated the local draft', 'status.backupExported': 'JSON backup exported; keep it before clearing browser data',
      ...
      'status.selected': 'Selected', 'message.dimensionStart': 'Click to set dimension start', 'message.dimensionEnd': 'Click to set dimension end',
      ...
      'prop.steps': 'Steps',
      'object.wall': 'Wall', 'object.door': 'Door', 'object.window': 'Window', 'object.furniture': 'Furniture', 'action.delete': 'Delete',
