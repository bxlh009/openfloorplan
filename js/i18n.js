...
(function () {
  const dict = {
    zh: {
      ...
      'control.sun': '阳光', 'control.cutaway': '剖切视图', 'control.exterior': '完整外观', 'control.walk': '漫游', 'control.walkExit': '退出漫游', 'control.exportPng': '导出 PNG',
    ...
    en: {
      ...
      'control.sun': 'Sun', 'control.cutaway': 'Cutaway', 'control.exterior': 'Exterior', 'control.walk': 'Walk', 'control.walkExit': 'Exit walk', 'control.exportPng': 'Export PNG',
