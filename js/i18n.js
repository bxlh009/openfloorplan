...
(function () {
  const dict = {
    zh: {
      ...
      'section.drawing': '绘图', 'section.architecture': '建筑构件风格', 'section.furniture': '家具', 'section.properties': '属性',
    ...
    en: {
      ...
      'section.drawing': 'Drawing', 'section.architecture': 'Architectural details', 'section.furniture': 'Furniture', 'section.properties': 'Properties',
